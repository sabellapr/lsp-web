...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input id="price" class="form-control" type="text" name="price" value="<?php echo e(old('price')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input id="quantity" class="form-control" type="text" name="quantity" value="<?php echo e(old('quantity')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\lsp\web\cashier-lsp-main\resources\views/products/create.blade.php ENDPATH**/ ?>